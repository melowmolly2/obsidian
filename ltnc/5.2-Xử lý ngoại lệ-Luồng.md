...
- Loại 3: Lỗi (Error)
	...
	- Ví dụ: Chương trình mở một tệp thành công, đã sẵn sàng đọc dữ liệu từ tệp. Tuy nhiên, chương trình không thể đọc được nội dung tệp vì lỗi nào đó thuộc phần cứng hoặc thuộc hệ t