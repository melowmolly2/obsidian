# Tuần 1
## Vector
- Tích vô hướng: $A\cdot B=|A||B|\cos\phi$ 
- Tích có hướng (độ lớn): $C=AB\sin \phi$ 
## Chuyển động thẳng với gia tốc không đổi
- Vận tốc: $v_x=v_{0x}+a_xt$ 
- Vị trí: $x=x_0+v_{0x}t+\frac12a_xt^2$ 
- Hệ thức độc lập thời gian: $v_x^2=v_{0x}^2+2a_x(x-x_0)$ 
## Chuyển động ném (Projectile Motion) 
