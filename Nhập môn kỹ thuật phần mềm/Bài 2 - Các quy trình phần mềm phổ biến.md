...
Khi thực hiện các công việc trong quá trình phát triển, thông thường chúng ta cần viết ra tài liệu là sản phẩm kết quả. Các tài liệu này có vai trò làm các bên liên quan hiểu rõ nhau và giúp phát hiện các vấn đề sớm, đông thời cũng giảm rủi ro cho dự án khi có thay đổi nhân sự. 
...
**Sai lầm kinh điển về sản phẩm.** Sai lầm liên quan đến sản phẩm đầu tiên là nghĩ ra quá nhiều yêu cầu mà thực tế không cần đến hay lại quá qua loa để thiếu sót các chức năng cần thiết hoặc một số yêu cầu quá khó, khi đó vấn đề không thuộc dự án phát triển thuần túy nữa mà nó phải thuộc dự án nghiên cứu phát triển (R&D) - có rủi ro cao. 
<iframe width="560" height="315" src="https://www.youtube.com/embed/pdT4j5dCz48?si=A0RR0R__4vFDcuMJ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
**Sai lầm kính điển về công nghệ.** Sai lầm về công nghệ đầu tiên là hội chứng viên đạn bạc, tức là quá tin vào quảng cáo, là công nghệ đó có thể giải quyết mọi vấn đề. Sai lầm khác là chuyển đổi công cụ trong quá trình phát triển và công cụ mới có thể gay ra vấn đề không lường trước. Cuối cùng là thiếu công cụ quản lý phiên bản, có thể gay ra thảm họa cho dự án. 

<iframe width="560" height="315" src="https://www.youtube.com/embed/IRzhjI1wbmA?si=6PI0QbXDCLC5xLik" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
